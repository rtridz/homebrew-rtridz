class SipQt4 < Formula
  ...
  def install
    ...
    Language::Python.each_python(build) do |python, version|
      ...
      system python, "configure.py",
                     ...
                     "--destdir=#{lib}/qt/python#{version}/site-packages",
                     "--bindir=#{bin}",
                     "--incdir=#{include}",
  ...
  def post_install
    ...
    Language::Python.each_python(build) do |_python, version|
      subpth = "qt/python#{version}/site-packages"
  ...
  def caveats
    ...
    s += "Python modules in:\n"
    Language::Python.each_python(build) do |_python, version|
      s += "  #{HOMEBREW_PREFIX}/lib/qt/python#{version}/site-packages/PyQt4"
    end
    s
  end
  ...
  test do
    ...
    Language::Python.each_python(build) do |python, version|
      site_pkgs = "#{HOMEBREW_PREFIX}/lib/qt/python#{version}/site-packages"
